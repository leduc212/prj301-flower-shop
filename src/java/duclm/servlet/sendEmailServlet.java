    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String message = "<!DOCTYPE html>\n"
                    ...
                    + "\n"
                    + "<body>\n"
                    + "    <h3 style=\"color: blue;\">Your account has been created successfully!</h3>\n"
                    + "    <div>NICHE PlantShop</div>\n"
                    + "    <div>Contact us at: admin@gmail.com</div>\n"
                    + "    <div>Phone : 0123456789</div>\n"
                    + "    <div>Address : The USA</div>\n"
                    + "    <h3 style=\"color: blue;\">Thank you very much!</h3>\n"
                    + "\n"
                    + "</body>\n"
                    + "\n"
                    + "</html>";
            send(email, subject, message, "ducfortune0@gmail.com", "minhduc2102");
